...
class Search2e extends Component {
  state = {
    animals: [],
        ...
        <main>
          <div className="wrapper">
            <section className="search">
              <h2>{this.state.isLoaded ? 'Результати пошуку' : 'Завантажуємо...'}</h2>
              <nav>
                <a href="/">Назад</a>
                <a href="/">2</a>
                <a href="/">3</a>
              ...
              <div className="search-block">
                ...
                <div className="search-filter">
                  ...
                  <div className="search-inputs">
                    <select ref="type" name="type" id="" onChange={this.setSearchParams}>
                      <option value="all">Тип (усі)</option>
                      <option value="cat">Коти</option>
                      <option value="dog">Собаки</option>
                      <option value="other">Інші</option>
                    </select>
                    <select ref="gender" name="gender" id="" onChange={this.setSearchParams}>
                      <option value="all">Стать (усі)</option>
                      <option value="he">Він</option>
                      <option value="she">Вона</option>
                    </select>
                    <select ref="status" name="status" id="" onChange={this.setSearchParams}>
